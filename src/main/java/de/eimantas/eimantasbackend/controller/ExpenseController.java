...
public class ExpenseController {
    ...
    public Collection<ExpenseDTO> getExpenses(Principal principal) {
        ...
        logger.info(String.format("returning count: %d", StreamSupport.stream(expensesService.findAll().spliterator(), false)
    ...
    @CrossOrigin(origins = "*")
    public Collection<ExpenseDTO> getExpensesInPeriod(Principal principal, @RequestParam("from") @DateTimeFormat(pattern = "yyyy-MM-dd") Date fromDate, @RequestParam("to") @DateTimeFormat(pattern = "yyyy-MM-dd") Date toDate) throws BadRequestException {
